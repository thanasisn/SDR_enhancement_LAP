...
\caption{Relative frequency distribution of CE groups of consequent CE events according to their duration for Thessaloniki in the period 1993 -- 2023. The histogram was splited in two plots with differnt y-axis limits for better readability.}\label{fig:ceg-duration-distribution}
\end{figure}
