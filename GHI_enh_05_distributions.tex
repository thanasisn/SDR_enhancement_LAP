...
\begin{verbatim}
Warning: The dot-dot notation (`..count..`) was
...
\begin{verbatim}
Warning: Removed 398 rows containing non-finite
outside the scale range (`stat_bin()`).
\end{verbatim}

\begin{verbatim}
Warning: Removed 106426 rows containing non-finite
outside the scale range (`stat_bin()`).
\end{verbatim}
...
\begin{verbatim}
2024-08-28 16:14:44.1 athan@tyler GHI_enh_05_distributions.R 0.552170 mins
\end{verbatim}
