...
\begin{verbatim}
Warning: Removed 403 rows containing non-finite outside the scale
range (`stat_bin()`).
\end{verbatim}

\begin{verbatim}
Warning: Removed 106810 rows containing non-finite outside the scale
range (`stat_bin()`).
\end{verbatim}
...
\begin{verbatim}
2024-09-05 05:29:44.2 athan@sagan GHI_enh_05_distributions.R 0.976907 mins
\end{verbatim}
