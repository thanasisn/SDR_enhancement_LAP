...
\begin{verbatim}
Warning: Removed 106426 rows containing non-finite outside the scale
range (`stat_bin()`).
\end{verbatim}
...
Missing days 6.005293 \% 658 from 10957

\textbf{END}

\begin{verbatim}
2024-08-28 09:48:52.8 athan@sagan GHI_enh_05_distributions.R 0.201434 mins
\end{verbatim}
