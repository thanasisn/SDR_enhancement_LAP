...
{\centering \includegraphics[width=1\linewidth]{GHI_enh_05_distributions_files/figure-latex/relative_distributions-1} 

}

\caption{ - empty caption - }(\#fig:relative_distributions-1)
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{GHI_enh_05_distributions_files/figure-latex/relative_distributions-2} 

}

\caption{ - empty caption - }(\#fig:relative_distributions-2)
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{GHI_enh_05_distributions_files/figure-latex/relative_distributions-3} 

}

\caption{ - empty caption - }(\#fig:relative_distributions-3)
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{GHI_enh_05_distributions_files/figure-latex/relative_distributions-4} 

}

\caption{ - empty caption - }(\#fig:relative_distributions-4)
\end{figure}
...
\caption{ - empty caption - }(\#fig:P-relative-distribution-diff)
\end{figure}
\begin{figure}[H]
...
\caption{ - empty caption - }(\#fig:P-extreme-distribution)
\end{figure}
...
\begin{verbatim}
2024-06-06 10:30:11.5 athan@tyler GHI_enh_05_distributions.R 0.229384 mins
\end{verbatim}
