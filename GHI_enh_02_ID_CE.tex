...
\NormalTok{  trans\_trend }\OtherTok{\textless{}{-}}\NormalTok{ trend\_polyf}
  ...
  \FunctionTok{trans\_trend}\NormalTok{(}\DecValTok{2000}\NormalTok{)}

  \DocumentationTok{\#\# }\AlertTok{TEST}
  \DocumentationTok{\#\# remove long term change of GHI for testing}
  \CommentTok{\# warning("!! THIS IS A }\AlertTok{TEST}\CommentTok{ !!")}
  \CommentTok{\# trans\_trend \textless{}{-} function(x) \{x * 0\}}
  \CommentTok{\# trans\_trend(2000)}
...
\begin{verbatim}
Range of delta(AOD): -2 0.092 

Range of delta(AOD): -2.01 0.09 

GHI_model (abs) = -68231.52 + 68.09819 * year_frac + -0.01685135 * year_frac^2 

GHI_model (rat) = -121.5 + 0.1203 * x + -2.977e-05 * x^2 

GHI_model (%)   = -12154 + 12.03 * x + -0.002977 * x^2 

GHI_model (%)   = -12153.97 + 12.0304 * x + -0.002977 * x^2 
\end{verbatim}
...
\begin{verbatim}
2024-10-10 17:31:27.7 athan@tyler GHI_enh_02_ID_CE.R 32.595986 mins
\end{verbatim}
