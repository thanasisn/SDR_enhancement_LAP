...
"${rclone}" ${otheropt} ${bwlimit} --verbose --config "$config" --max-depth 2 --include "Without_long_term_change_of_GHI/*.{pdf}"          copy "/home/athan/MANUSCRIPTS/02_enhancement/"        "lapauththanasis:/Enhance"
