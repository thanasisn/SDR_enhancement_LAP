...
$45.6 \pm 21.9\frac{cases}{year}$, and a trend in the corresponding
irradiation of $116.9 \pm 67.8\frac{kJ}{year}$. The peak of the CE
events was observed during May and June. CE events with duration longer
than 5 min are very rare (\< 80%), with exceptions lasting over an hour
and up to 140 minutes. Finally, we have detected enhancements above the
total solar irradiance at the top of the atmosphere of up to
$400\frac{W}{m^{2}}$, with $75\%$ of the cases below
$200\frac{W}{m^{2}}$. Most of these extreme events occur in spring --
...
the entire period of study. For the period 1994-1996 where no AOD data
are available, we assumed that the changes in GHI follow the same
polynomial fit. From Figure 2 it appears that the adjustment of GHI~ref~
for the long-term changes in AOD is relatively small, up to 1.5%.
...
one.](media/image9.png){width="5.833333333333333in"
...
![](media/image3.png){width="3.15625in" height="6.15625in"}
...
months are May and June, with their median representing about 2.5% of
...
*and the upper* $75\%$ *percentileswith* *the thick horizontal line*
...
Mediterranean resulting in different cloud patterns, that may affect the
...
thick horizontal line representing the. The vertical lines (whiskers)
extend between the maximum and minimum monthly values.
...
$400\frac{W}{m^{2}}$, while in $75\%$ of the cases the excess irradiance
is below $200\frac{W}{m^{2}}$. The OI for the most frequent ECEs ranges
between $140$ and $180\frac{W}{m^{2}}$. These findings are in accordance
...
$140$ minutes, while the duration of $80\%$ of them is bellow $5$
minutes.
...
irradiance is below $200\frac{W}{m^{2}}$. The climatological
