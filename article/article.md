...
abstract: |
  ...
  \(+113\pm 35\,\text{cases}/\text{year}\), and a trend in the
  corresponding irradiation of \(+336.2\pm 114.1\,\text{kJ}/\text{year}\).
  To our knowledge, such long-term changes in CE events have not been
  presented in the past. The peak of the CE events was observed during May
  and June. CE events with duration longer than 10\nobreakspace{}min are
  very rare (\(<8\,\%\)), with exceptions lasting over an hour and up to
  140 minutes. Finally, we have detected enhancements above the total
  solar irradiance at the top of the atmosphere for the same solar zenith
...
also have some practical implications.  The intensity and duration of enhancements
...
for the construction of the LUT.  Of note, the total ozone column plays a minor role
in GHI as it affects mainly the UV wavelengths. However, it is entered in the RTM
simulations via the seasonal atmospheric profiles. The long-term variability of total
ozone in Thessaloniki for the period of study is very small thus cannot affect the
long-term $\text{GHI}_\text{ref}$.
...
\begin{equation}
\Delta(\text{GHI}) [\%] = -12153.97 + 12.0304 \cdot y -0.002977 \cdot y^2 \label{eq:AODchange}
\end{equation}
where $y$ is the year in decimal form.  The resulting change in
$\text{GHI}_\text{ref}$ ranges between $-2\,\%$ in 1994 and $0.05\,\%$ in the end of
2023, peaking at $0.09\,\%$ in the mid-2020. Finally, we applied these long-term
...
<!--
GHI_model (%)
  -12153.97 + 12.0304 * x + -0.002977 * x^2
-->
<!--
As AERONET data
...
$15.5\,\text{mm}$ taken from the Cimel, and for a SZA of $55^\circ$ reveal a change of
...
$25\,\text{W}/\text{m}^2$.  The long-term difference between the
measured GHI and the $\text{GHI}_{\text{ref}}$ for the same cloud-free days has a
trend of $0.2\,\text{W}/\text{m}^2$ per year which further supports the validity of
the produced long-term $\text{GHI}_\text{ref}$.
...
AOD. A small fraction of these data corresponds to cases with thin cirrus clouds
...
\caption{Relation of excess irradiation of CE groups with their duration for Thessaloniki in the period 1994 -- 2023. The logarithmic color scale denotes the frequency of the respective groups. Note that 19 points for groups with duration higher than 60 min are not shown.}\label{fig:group-2d}
\end{figure}
