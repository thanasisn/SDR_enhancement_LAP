...
The GHI data are available as hourly values in the WMO World Radiation Data Center (http://wrdc.mgo.rssi.ru).
The relevant source code can be found in github and is register to zenodo
the preparation of GHI data
the detection of clouds
the processes for this manuscript

Cloud identification @thanasis_n_2024_13744460

GHI @natsis_2024_13744467

this @thanasis_n_2024_13744472
