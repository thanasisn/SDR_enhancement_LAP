...
cloud-free model and was already adjusted and applied to our data [@Natsis2023].
<!--
...
effects of aerosols and water vapor which were not considered in the simple method.
To produce a more representative reference we included the effects of these factors
...
modelled cloud-free irradiance, and $i$ each of the one-minute observation.  This is
...
between the measured and the modeled cloud-free irradiance for one year, where the CE
