...
included an example of the CE identification for a selected day \ldots.
appendix\ldots. where the use of the reference and the threshold are
shown, along with the relevant measurements.
