...
\caption{Relation of maximun over irradiance and CE group duration}\label{fig:unnamed-chunk-4}
\end{figure}
...
\caption{Distribution of the number of ECE cases}\label{fig:unnamed-chunk-5}
\end{figure}
...
\caption{Distribution of ECE above 'clear sky' reference}\label{fig:unnamed-chunk-6}
\end{figure}
...
\caption{Distribution of ECE Irradiance above 'TSI'}\label{fig:unnamed-chunk-7}
\end{figure}
...
\caption{Distribution of }\label{fig:unnamed-chunk-8}
\end{figure}
