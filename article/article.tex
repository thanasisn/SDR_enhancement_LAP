...
days. For the latter case and where needed in some of the edge cases, we
also used images from a sky-camera to further aid the decision of the
manual inspection.
...
atmosphere. In this case the threshold EEEEEEEEEE: \begin{equation}
