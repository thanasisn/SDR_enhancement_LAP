...
\caption{Daily mean values and trend of the CE over irradiance.}(\#fig:CEmeanDaily)
\end{figure}
...
\caption{Treds of the mean over irradiance per CE}(\#fig:unnamed-chunk-1)
\end{figure}
...
\caption{Trend of number of CE cases}(\#fig:unnamed-chunk-2)
\end{figure}
...
\caption{Trend of the yearly excess energy due to CE over irradiance}(\#fig:unnamed-chunk-3)
\end{figure}
...
\caption{Distribution of the number of CE cases}(\#fig:unnamed-chunk-4)
\end{figure}
...
\caption{Distribution of CE above reference}(\#fig:unnamed-chunk-5)
\end{figure}
...
\caption{Distribution of CE groups}(\#fig:unnamed-chunk-6)
\end{figure}
...
\caption{Relation of mean over irradiance and CE group duration}(\#fig:unnamed-chunk-7)
\end{figure}
...
\caption{Relation of maximun over irradiance and CE group duration}(\#fig:unnamed-chunk-8)
\end{figure}
...
\caption{Distribution of the number of ECE cases}(\#fig:unnamed-chunk-9)
\end{figure}
...
\caption{Distribution of ECE above 'clear sky' reference}(\#fig:unnamed-chunk-10)
\end{figure}
...
\caption{Distribution of ECE Irradiance above 'TSI'}(\#fig:unnamed-chunk-11)
\end{figure}
...
\caption{Distribution of }(\#fig:unnamed-chunk-12)
\end{figure}
