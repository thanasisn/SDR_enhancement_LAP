...
less than 5 valid hours are rejected completely.
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{gcff}, toptitle=1mm, titlerule=0mm, colbacktitle=quarto-callout-important-color!10!white, rightrule=.15mm, left=2mm, opacityback=0, bottomtitle=1mm, coltitle=black, leftrule=.75mm, breakable, arc=.35mm, bottomrule=.15mm, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, toprule=.15mm]
