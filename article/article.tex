...
\(1416.6\,\text{W}/\text{m}^2\) \(24\ May 2007\,\text{W}/\text{m}^2\)
\(345.9\,\text{W}/\text{m}^2\) \(32.3\,\%\)

\(861.8\,\text{W}/\text{m}^2\) \(28\ October 2016\,\text{W}/\text{m}^2\)
...
\(1416.6\,\text{W}/\text{m}^2\) on 24~May 2007, corresponding to OI of
\(345.9\,\text{W}/\text{m}^2\). !!!!\(32.3\,\%\).!!!!! The strongest CE
event of \(49.7\,\%\) above the clear sky threshold was observed on
28~October 2016. !!!\(864\,\text{W}/\text{m}^2\)!!!! In the following
