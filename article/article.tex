...
autoregressive model with lag of 1 day, with the `maximum likelihood'
...
error. We observe an negligible change of \(0.087\pm 0.08\,W/m^2/y\) on
the mean OIR.
...
one-minute measurements. Although, the trend of the mean OIR has very
weak statistical significance, the annual number of CE occurrences,
shows a steady increase of \(45.6\pm 21.9\,\text{cases}/y\)
...
total energy balance on the atmosphere. The net solar radiation of the
region is not increased, but rather redistributed through the CE events.
Resulting, instantaneous values, that can exceed the equivalent clear
sky irradiance to a considerable level.
