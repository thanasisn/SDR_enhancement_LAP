...
Thessaloniki},city={Thessaloniki},postcode={54124},country={Greece},}
  ...
  events of \(+113\pm 35\,\text{cases}/\text{year}\), and a trend in the
  corresponding irradiation of
  \(+336.2\pm 114.1\,\text{kJ}/\text{year}\). To our knowledge, such
...
compiled by \citet{Martins2022}. Cloud enhancements can also have some
...
\(\pm2\sigma\), were used as inputs to the RTM for the construction of
...
constant WC of \(15.5\,\text{mm}\) derived from the Cimel record, we
...
\end{equation} where \(y\) is the year in decimal form. The resulting
change in \(\text{GHI}_\text{ref}\) ranges between \(-2\,\%\) in 1994
and \(0.05\,\%\) in the end of 2023, peaking at \(0.09\,\%\) in the
...
measured GHI and the \(\text{GHI}_{\text{ref}}\) for the same cloud-free
days has a trend of \(0.2\,\text{W}/\text{m}^2\) per year which further
supports the validity of the produced long-term
\(\text{GHI}_\text{ref}\).
...
variability of AOD. A small fraction of these data corresponds to cases
...
\(2.36\,\%\) were identified as CE events and \(0.036\,\%\) as ECE
events. The highest recorded GHI due to CE was
\(1416.6\,\text{W}/\text{m}^2\) on 24~May 2007 at a SZA of
\(19.9^\circ\) corresponding to OI of \(370.6\,\text{W}/\text{m}^2\) or
\(35.4\,\%\) above the threshold. The strongest CE event of \(53.2\,\%\)
...
of \(299.1\,\text{W}/\text{m}^2\). Both cases are also ECE events with
...
number of CE events (\(+113\pm 35\,\text{cases}/\text{year}\)) and the
excess irradiation (\(+336.2\pm 114.1\,\text{kJ}/\text{year}\)), while
...
\(+42.7\pm 2.8\,\text{W}/\text{m}^2\). The yearly excess irradiation due
...
below the long-term average of \(42.7\,\text{W}/\text{m}^2\), while
\(9.7\,\%\) of the events correspond to OI larger than
\(100\,\text{W}/\text{m}^2\) and up to the highest value of
\(438.2\,\text{W}/\text{m}^2\). This distribution is indicative of the
...
steps of one minute. We have identified 35342 groups of CE events in the
...
of \(+113.4\pm 35.5\,\text{cases}/\text{year}\), with the mean annual
irradiation of the CE events increasing with a rate of
\(+336.2\pm 114.1\,\text{kJ}/\text{year}\). The most active months of CE
