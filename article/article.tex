...
\end{equation} where \(x\) the year as a continuous variable. The
...
\(`r C4_GLB_diff_THRES`\,\text{W}/\text{m}^2\). The long-term difference
between the measured GHI and the \(\text{GHI}_{\text{ref}}\) for the
same cloud-free days has a trend of \(0.2\,\text{W}/\text{m}^2\) per
year which further supports the validity of the produced long-term
\(\text{GHI}_\text{ref}\).
