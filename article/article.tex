...
\caption{Relative frequency distribution of CE events in Thessaloniki for the period 1992 -- 2023 as a function of OIR.}\label{fig:ovir-distribution}
\end{figure}
...
\caption{Relative frequency distribution of CE groups of consequent CE events according to their duration for Thessaloniki in the period 1992 -- 2023.}\label{fig:ceg-duration-distribution}
\end{figure}
...
\caption{Relation of excess irradiation of CE groups with their duration for Thessaloniki in the period 1992 -- 2023. The logarithmic color scale denotes the frequency of the respective groups of events.}\label{fig:group-2d}
\end{figure}
...
\caption{Distribution of ECE events in Thessaloniki for the period 1992 -- 2023.}\label{fig:P-extreme-distribution}
\end{figure}
...
the year and particularly in the periods March -- June, September and
