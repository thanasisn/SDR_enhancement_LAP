...
\text{CE} : \text{E}_\text{i} > \text{E}_\text{CSlim,i}, \text{where} \begin{cases}
 \text{E}_\text{CSlim,i} = 1.03 \cdot \text{E}_\text{CSm,i}, & \text{$\theta \leq 90^\circ$}\\
\text{E}_\text{CSlim,i} = \left ({ 1.05 + \frac{1.03 - 1.05}{90 - 78} \cdot (\theta- 78) } \right ) \cdot \text{E}_\text{CSm,i}, & \text{$ 78^\circ > \theta > 90^\circ$}\\
...
records of GHI, of which \(1.824\,\%\) are CE and \(0.036\,\%\) are ECE
events. The highest GHI recorder was \(1416.6\,W/m^2\) on 24~May 2007.
The absolute stronger CE event had an OIR of \(345.53\,W/m^2\) on 24~May
2007. The relative stronger CE event was \(51.6\,\%\) above the clear
...
error. We observe an increase of \(0.216\pm 0.082\,W/m^2/y\) on the mean
OIR.
...
\(339.2\pm 71.8\,kJ/y\) (Figure~\ref{fig:P-energy-sum}), witch follows
...
duration of multiple of minutes. We have identified 28939 groups, where
