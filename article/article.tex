...
The use of the actual modeled values of clear sky GHI, described above ,
can not provide us with a robust method to distinguish the CE cases, due
to the limited accuracy of the input data. Our main focus was to
positively identify over irradiance events from CEs, so we created an
upper envelope of the clear sky irradiance,

\ldots\ldots\ldots\ldots\ldots\ldots\ldots\ldots\ldots..

above which, any GHI value can safely attributed to CE. We evaluated the
