...
A lot of research has been focuces on predicting the renewable energy production in a
...
and the observer (Gueymard 2017; Veerman, Van Stratum, and Van Heerwaarden 2022). As such, there are multiple contributing mechanism that can create
the observed irradiance enhancements.
