...
than 80\%. Due to the selection of the simulations with lower AOD and
WC, these values have a positive bias of more than (Correlation). This
was desired so that together with the PSE criterion, we could achieve a
clear distinction of PSE cases.
...
GHI observations in each month. All three quantities show increasing
trends, most pronounced for the frequency of occurrence
