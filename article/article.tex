...
records of GHI, of which \(1.906\,\%\) are CE and \(0.036\,\%\) are ECE
events. The highest GHI recorder was \(1416.6\,W/m^2\) on 24~May 2007.
The absolute stronger CE event had an OIR of \(353.46\,W/m^2\) on
21~June 2001. The relative stronger CE event was \(49.9\,\%\) above the
...
error. We observe an increase of \(0.066\pm 0.08\,W/m^2/y\) on the mean
OIR.
...
one-minute measurements. The trend of OIR is \(0.03\pm 0.11\,W/m^2/y\)
...
\(50.7\pm 71.2\,kJ/y\) (Figure~\ref{fig:P-energy-sum}), witch follows
...
duration of multiple of minutes. We have identified 30221 groups, where
