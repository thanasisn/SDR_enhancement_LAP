...
source of the atmosphere and biosphere. It drives and governs the climate
(Gray et al. 2010). It has direct practical application, in different industries, like
energy production and agriculture method. The variability of its intensity, can
cause difficulties in predicting the yield and designing the appropriate equipment.
A lot of research has been focuces on predicting the renewable energy production in a fine
timescale and in near real-time (for a review see Inman, Pedro, and Coimbra (2013); Graabak and Korpås (2016)).

A big aspect of this variability are the interaction with the clouds. In general,
clouds absorb part of the solar irradiance, but under certain conditions, can
enhance the total shortwave irradiance reaching the ground. This effect can locally
increase the observed total shortwave irradiance higher than the expected clear sky
irradiance {[}see references therein{]}.

The enhancements can effect the efficiency and stability of photovoltaic power
production (Lappalainen and Kleissl 2020; Järvelä and Valkealahti 2020).

And extreme enhancements cases have the potential to compromise the integrity of the
infrastructure (Do Nascimento et al. 2019).

Those enhancements have been reported to be able to exceed \ldots. and duration.
For a list of recorded extreme cases
Martins, Mantelli, and Rüther (2022)

Some of the proposed underling mechanisms of those events have been summarized
by Gueymard (2017), and include scattering on the edge of cumulus clouds or through
...
thickness and constitution, and the relative position of the sun, the clouds, and the
observer. As such, there multiple contributing mechanism can create the
observed irradiance enhancements.

The forward scattering of clouds near the sun has been observed to produce cases of
extreme enhancement irradiances (Georgi Hristov Yordanov, Saetre, and Midtgård 2015).

It has been reported than enhancements events can interfere in the comparison of
ground data and satellite observe ovations (Damiani et al. 2018)

Instruments respose \ldots.
Martins, Mantelli, and Rüther (2022)

Study of the mechanism has also been done with modeling of different cloud types and
atmospheric conditions.
Gueymard (2017); Veerman, Van Stratum, and Van Heerwaarden (2022)

Methods of identification in the literature usually include the use of a simulated clear sky radiation
Vamvakas, Salamalikis, and Kazantzidis (2020); Mol, Knap, and Van Heerwaarden (2023);
...
phenomenon, it's Climatology, and some of its general characteristics.

In the relative bibliography different definition have been used for these events, some of
the are summarized by Gueymard (2017).
