...
{\centering \includegraphics[width=0.7\linewidth]{../images/P_energy-6} 
...
{\centering \includegraphics[width=0.7\linewidth]{../images/P_energy-5} 
...
{\centering \includegraphics[width=0.7\linewidth]{../images/P_energy-8} 
...
The distribution of the CE over irradiance spreads uniformly with the over iradiance intensity

\begin{figure}[h!]

{\centering \includegraphics[width=0.7\linewidth]{../images/P-relative-distribution-diff-1} 

}

\caption{Distribution of CE over irradiance}\label{fig:unnamed-chunk-3}
\end{figure}
...
\caption{Distribution of CE groups}\label{fig:unnamed-chunk-4}
\end{figure}
...
\caption{Relation of mean over irradiance and CE group duration}\label{fig:unnamed-chunk-5}
\end{figure}
...
\caption{Relation of maximun over irradiance and CE group duration}\label{fig:unnamed-chunk-6}
\end{figure}
...
\caption{Distribution of the number of ECE cases}\label{fig:unnamed-chunk-7}
\end{figure}
...
\caption{Distribution of ECE above 'clear sky' reference}\label{fig:unnamed-chunk-8}
\end{figure}
...
\caption{Distribution of ECE Irradiance above 'TSI'}\label{fig:unnamed-chunk-9}
\end{figure}
...
\caption{Distribution of }\label{fig:unnamed-chunk-10}
\end{figure}
