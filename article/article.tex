...
Clear sky identification - helps on determining thresholds

Criteria for enhancement based on TSI - some other were tested
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, coltitle=black, left=2mm, colframe=quarto-callout-important-color-frame, rightrule=.15mm, toprule=.15mm, colbacktitle=quarto-callout-important-color!10!white, titlerule=0mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{gcff}, leftrule=.75mm, opacityback=0, breakable, bottomtitle=1mm, opacitybacktitle=0.6, toptitle=1mm, arc=.35mm, bottomrule=.15mm]
