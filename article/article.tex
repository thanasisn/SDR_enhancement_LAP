...
\(2.23\,\%\) were identified as CE events and \(0.036\,\%\) as ECE
events. The highest recorded GHI due to CE was
\(1416.6\,\text{W}/\text{m}^2\) on 24~May 2007 at a SZA of
\(19.9^\circ\) corresponding to OI of \(366.3\,\text{W}/\text{m}^2\) or
\(34.9\,\%\) above the threshold. The strongest CE event of \(53.2\,\%\)
...
of \(299.4\,\text{W}/\text{m}^2\). Both cases are also ECE events with
...
number of CE events (\(+148\pm 35\,\text{cases}/\text{year}\)) and the
excess irradiation (\(+430.8\pm 113.2\,\text{kJ}/\text{year}\)), while
the trend in the yearly mean OI is negligible
(\(+0.2\pm 0.2\,\text{W}/\text{m}^2/\text{year}\)) and of no statistical
significance. The average OI for the entire period is
\(+42.4\pm 3.1\,\text{W}/\text{m}^2\). The yearly excess irradiation due
...
below the long-term average of \(42.4\,\text{W}/\text{m}^2\), while
\(9.6\,\%\) of the events correspond to OI larger than
\(100\,\text{W}/\text{m}^2\) and up to the highest value of
\(438.3\,\text{W}/\text{m}^2\). This distribution is indicative of the
...
steps of one minute. We have identified 33663 groups of CE events in the
...
of \(+148.3\pm 35.3\,\text{cases}/\text{year}\), with the mean annual
irradiation of the CE events increasing with a rate of
\(+430.8\pm 113.2\,\text{kJ}/\text{year}\). The most active months of CE
