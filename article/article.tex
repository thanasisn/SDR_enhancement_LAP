...
{\centering \includegraphics[width=1\linewidth]{../images/P_CS_change-1} 
...
{\centering \includegraphics[width=1\linewidth]{../images/P_energy-7} 
...
{\centering \includegraphics[width=1\linewidth]{../images/P_energy-6} 
...
{\centering \includegraphics[width=1\linewidth]{../images/P_energy-5} 
...
{\centering \includegraphics[width=1\linewidth]{../images/clim_CE_month_norm_MAX_median_N-2} 
...
{\centering \includegraphics[width=1\linewidth]{../images/clim_ECE_month_norm_MAX_median_N-2} 
...
{\centering \includegraphics[width=1\linewidth]{../images/example_days-18} 
...
{\centering \includegraphics[width=1\linewidth]{../images/example_years-13} 
