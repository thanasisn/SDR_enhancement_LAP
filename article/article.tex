...
{\centering \includegraphics[width=0.7\linewidth]{../images/P_energy-7} 

}

\caption{Treds of the mean over irradiance per CE}\label{fig:unnamed-chunk-2}
\end{figure}
...
\caption{Trend of number of CE cases}\label{fig:unnamed-chunk-3}
\end{figure}

\begin{figure}[h!]

{\centering \includegraphics[width=0.7\linewidth]{../images/P_energy-2} 

}

\caption{Trend of number of CE cases}\label{fig:unnamed-chunk-4}
\end{figure}
...
\caption{Trend of the yearly excess energy due to CE over irradiance}\label{fig:unnamed-chunk-5}
\end{figure}

\begin{figure}[h!]

{\centering \includegraphics[width=0.7\linewidth]{../images/P_energy-1} 

}

\caption{Trend of the yearly excess energy due to CE over irradiance}\label{fig:unnamed-chunk-6}
\end{figure}
...
\caption{Distribution of the number of CE cases}\label{fig:unnamed-chunk-7}
\end{figure}
...
\caption{Distribution of CE above reference}\label{fig:unnamed-chunk-8}
\end{figure}
...
\caption{Distribution of CE groups}\label{fig:unnamed-chunk-9}
\end{figure}
...
\caption{Relation of mean over irradiance and CE group duration}\label{fig:unnamed-chunk-10}
\end{figure}
...
\caption{Relation of maximun over irradiance and CE group duration}\label{fig:unnamed-chunk-11}
\end{figure}
...
\caption{Distribution of the number of ECE cases}\label{fig:unnamed-chunk-12}
\end{figure}
...
\caption{Distribution of ECE above 'clear sky' reference}\label{fig:unnamed-chunk-13}
\end{figure}
...
\caption{Distribution of ECE Irradiance above 'TSI'}\label{fig:unnamed-chunk-14}
\end{figure}
...
\caption{Distribution of }\label{fig:unnamed-chunk-15}
\end{figure}
...
\caption{Distribution of }\label{fig:unnamed-chunk-16}
\end{figure}
