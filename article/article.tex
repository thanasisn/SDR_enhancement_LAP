...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, left=2mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{gcff}, leftrule=.75mm, toprule=.15mm, coltitle=black, titlerule=0mm, arc=.35mm, opacitybacktitle=0.6, bottomtitle=1mm, breakable, colframe=quarto-callout-important-color-frame, opacityback=0, bottomrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, colback=white, toptitle=1mm]
