...
with Libradtran. For both, we use the AOD at \(500\,\text{nm}\), which
was inferred by the available Ångström exponent, and we choose the SZA
of \(55^\circ\) as a representative value for all runs.
