...
\text{CE: GHI} > \begin{cases}
1.05, & \text{if $\theta \leq 60^\circ$}.\\
1.18, & \text{if $ 80^\circ > \theta > 60^\circ$}.
\end{cases}
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, leftrule=.75mm, coltitle=black, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, colframe=quarto-callout-important-color-frame, left=2mm, titlerule=0mm, bottomtitle=1mm, colback=white, arc=.35mm, toptitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{gcff}, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6]
