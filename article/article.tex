...
measurements, including night time, near dusk and dawn. Days with less
than 5 complete hours are rejected completely.
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, breakable, left=2mm, rightrule=.15mm, bottomrule=.15mm, colframe=quarto-callout-important-color-frame, colback=white, toprule=.15mm, colbacktitle=quarto-callout-important-color!10!white, bottomtitle=1mm, toptitle=1mm, coltitle=black, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{gcff}, titlerule=0mm, arc=.35mm, opacityback=0, leftrule=.75mm]
