...
given in Figure\nobreakspace{}\ref{fig:CLB-daily}, as the daily mean of
the measured GHI.
...
the clear-sky irradiance for the whole period of study. The rate of
...
\(1.68\,\%\) were identified as CE events and \(0.04\,\%\) as ECE
...
\(31.4\,\%\) above the threshold. The strongest CE event of \(49.9\,\%\)
...
is negligible (\(+0.12\pm 0.1\,\text{W}/\text{m}^2/\text{year}\)) and of
no statistical significance. The average OI for the entire period is
...
below the long-term average of \(39.7\,\text{W}/\text{m}^2\), while
