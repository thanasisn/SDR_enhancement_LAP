...
$116.9 \pm 67.8\,\text{kJ}/\text{year}$. The peak of the CE events was
...
exceptions lasting over an hour. Finally we have detected enhancements
...
significance. The average OIR for the entire period is
$39.9\,\text{W}/\text{m}^{2} \pm 2.7\,\text{W}/\text{m}^{2}$. The
interannual variability of the data about the trend lines is quite
