...
and presence of EC events, (h) random selected days and (i) some manual
selected days that were included during the manual inspection process.
Where it was needed, for some of the edge cases, we also used images
from a sky-cam, to further aid the decisions of the manual inspection.
...
seasonal cycle. In Figure, we have the monthly box plot (whisker plot),
