...
%DIF ADD /home/athan/MANUSCRIPTS/02_enhancement/article/article.tex                 Thu Sep  5 09:58:25 2024
...
\DIFdelbegin \DIFdel{\(116.9\pm 67.8\,\text{kJ}/\text{year}\)}\DIFdelend \DIFaddbegin \DIFadd{\(+116.3\pm 68.2\,\text{kJ}/\text{year}\)}\DIFaddend . The peak of the CE events was
...
\DIFdelbegin \DIFdel{\(1.76\,\%\) }\DIFdelend \DIFaddbegin \DIFadd{\(1.78\,\%\) }\DIFaddend were identified as CE events and \DIFdelbegin \DIFdel{\(0.036\,\%\) }\DIFdelend \DIFaddbegin \DIFadd{\(0.04\,\%\) }\DIFaddend as ECE
events. The highest recorded GHI due to CE was
\(1416.6\,\text{W}/\text{m}^2\) on 24~May 2007 \DIFdelbegin \DIFdel{, corresponding to OIR }\DIFdelend \DIFaddbegin \DIFadd{at a SZA of
\(19.9^\circ\) corresponding to OI }\DIFaddend of \(345.9\,\text{W}/\text{m}^2\) \DIFaddbegin \DIFadd{or
\(32.3\,\%\) above the threshold}\DIFaddend . The strongest CE event of \(49.7\,\%\)
above the clear sky threshold was observed on 28~October \DIFdelbegin \DIFdel{2016. }\DIFdelend \DIFaddbegin \DIFadd{2016 at a SZA
...
(\DIFdelbegin \DIFdel{\(116.9 \pm 67.8\,\text{kJ}/\text{year}\)}\DIFdelend \DIFaddbegin \DIFadd{\(+116.3 \pm 68.2\,\text{kJ}/\text{year}\)}\DIFaddend ), which are also
statistically significant. In contrast the trend of the yearly mean \DIFdelbegin \DIFdel{OIR
}\DIFdelend \DIFaddbegin \DIFadd{OI
}\DIFaddend is negligible (\DIFdelbegin \DIFdel{\(0.1\pm 0.1\,\text{W}/\text{m}^2/\text{year}\)}\DIFdelend \DIFaddbegin \DIFadd{\(+0.03\pm 0.1\,\text{W}/\text{m}^2/\text{year}\)}\DIFaddend ) and of
...
\DIFdelbegin \DIFdel{\(39.9\pm 2.7\,\text{W}/\text{m}^2\)}\DIFdelend \DIFaddbegin \DIFadd{\(+40.1\pm 2.5\,\text{W}/\text{m}^2\)}\DIFaddend . The interannual variability of
...
below the long-term average of \DIFdelbegin \DIFdel{\(39.9\,\text{W}/\text{m}^2\)}\DIFdelend \DIFaddbegin \DIFadd{\(40.1\,\text{W}/\text{m}^2\)}\DIFaddend , while
...
\DIFdelbegin \DIFdel{\(116.9\pm 67.8\,\text{kJ}/\text{year}\)}\DIFdelend \DIFaddbegin \DIFadd{\(+116.3\pm 68.2\,\text{kJ}/\text{year}\)}\DIFaddend . The most active months of CE
