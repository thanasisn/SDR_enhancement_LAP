...
%DIF ADD /home/athan/MANUSCRIPTS/02_enhancement/article/article.tex                 Thu Oct 10 19:07:08 2024
...
\(\pm2\sigma\), were used as inputs to the RTM \DIFdelbegin \DIFdel{in }\DIFdelend \DIFaddbegin \DIFadd{for }\DIFaddend the construction of
the LUT. \DIFaddbegin \DIFadd{Of note, the total ozone column plays a minor role in GHI as it
...
\(25\,\text{W}/\text{m}^2\). \DIFaddbegin \DIFadd{The long-term difference between the
...
\DIFdelbegin \DIFdel{\(2.32\,\%\) }\DIFdelend \DIFaddbegin \DIFadd{\(2.36\,\%\) }\DIFaddend were identified as CE events and \(0.036\,\%\) as ECE
...
\(35.3\,\%\) }\DIFdelend \DIFaddbegin \DIFadd{\(370.6\,\text{W}/\text{m}^2\) or
\(35.4\,\%\) }\DIFaddend above the threshold. The strongest CE event of \DIFdelbegin \DIFdel{\(53\,\%\)
...
of \DIFdelbegin \DIFdel{\(298.4\,\text{W}/\text{m}^2\)}\DIFdelend \DIFaddbegin \DIFadd{\(299.1\,\text{W}/\text{m}^2\)}\DIFaddend . Both cases are also ECE events with
