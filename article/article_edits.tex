...
%DIF ADD /home/athan/MANUSCRIPTS/02_enhancement/article/article.tex                 Wed Aug 28 07:14:42 2024
...
\DIFdelbegin \DIFdel{\(1.76\,\%\) }\DIFdelend \DIFaddbegin \DIFadd{\(1.78\,\%\) }\DIFaddend were identified as CE events and \DIFdelbegin \DIFdel{\(0.036\,\%\) }\DIFdelend \DIFaddbegin \DIFadd{\(0.037\,\%\) }\DIFaddend as ECE
...
(\DIFdelbegin \DIFdel{\(116.9 \pm 67.8\,\text{kJ}/\text{year}\)}\DIFdelend \DIFaddbegin \DIFadd{\(+116.9 \pm 67.8\,\text{kJ}/\text{year}\)}\DIFaddend ), which are also
