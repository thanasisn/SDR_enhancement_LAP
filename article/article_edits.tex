...
%DIF ADD /home/athan/MANUSCRIPTS/02_enhancement/article/article.tex                 Thu Oct 10 10:25:02 2024
...
\Delta(\text{GHI}) [\%] = \DIFdelbegin \DIFdel{-12170 }\DIFdelend \DIFaddbegin \DIFadd{-12153.97 }\DIFaddend + \DIFdelbegin \DIFdel{12.05 }\DIFdelend \DIFaddbegin \DIFadd{12.0304 }\DIFaddend \cdot x \DIFdelbegin \DIFdel{+ -0.002981 }\DIFdelend \DIFaddbegin \DIFadd{-0.002977 }\DIFaddend \cdot x^2 \label{eq:AODchange}
...
\DIFdelbegin \DIFdel{\(2.32\,\%\) }\DIFdelend \DIFaddbegin \DIFadd{\(2.23\,\%\) }\DIFaddend were identified as CE events and \(0.036\,\%\) as ECE
events. The highest recorded GHI due to CE was
\(1416.6\,\text{W}/\text{m}^2\) on 24~May 2007 at a SZA of
\(19.9^\circ\) corresponding to OI of \DIFdelbegin \DIFdel{\(369.3\,\text{W}/\text{m}^2\) or
\(35.3\,\%\) }\DIFdelend \DIFaddbegin \DIFadd{\(366.3\,\text{W}/\text{m}^2\) or
\(34.9\,\%\) }\DIFaddend above the threshold. The strongest CE event of \DIFdelbegin \DIFdel{\(53\,\%\)
}\DIFdelend \DIFaddbegin \DIFadd{\(53.2\,\%\)
}\DIFaddend above the cloud-free threshold was observed on 28~October 2016 at a SZA
of \(59.2^\circ\) with a GHI of \(861.8\,\text{W}/\text{m}^2\) and a OI
of \DIFdelbegin \DIFdel{\(298.4\,\text{W}/\text{m}^2\)}\DIFdelend \DIFaddbegin \DIFadd{\(299.4\,\text{W}/\text{m}^2\)}\DIFaddend . Both cases are also ECE events with
...
excess irradiation (\DIFdelbegin \DIFdel{\(+329.9 \pm 112\,\text{kJ}/\text{year}\)}\DIFdelend \DIFaddbegin \DIFadd{\(+430.8\pm 113.2\,\text{kJ}/\text{year}\)}\DIFaddend ), while
the trend in the yearly mean OI is negligible
(\DIFdelbegin \DIFdel{\(+0.1\pm 0.2\,\text{W}/\text{m}^2/\text{year}\)}\DIFdelend \DIFaddbegin \DIFadd{\(+0.2\pm 0.2\,\text{W}/\text{m}^2/\text{year}\)}\DIFaddend ) and of no statistical
significance. The average OI for the entire period is
\DIFdelbegin \DIFdel{\(+42.6\pm 2.8\,\text{W}/\text{m}^2\)}\DIFdelend \DIFaddbegin \DIFadd{\(+42.4\pm 3.1\,\text{W}/\text{m}^2\)}\DIFaddend . The yearly excess irradiation due
...
below the long-term average of \DIFdelbegin \DIFdel{\(42.6\,\text{W}/\text{m}^2\)}\DIFdelend \DIFaddbegin \DIFadd{\(42.4\,\text{W}/\text{m}^2\)}\DIFaddend , while
\(9.6\,\%\) of the events correspond to OI larger than
\(100\,\text{W}/\text{m}^2\) and up to the highest value of
\DIFdelbegin \DIFdel{\(437\,\text{W}/\text{m}^2\)}\DIFdelend \DIFaddbegin \DIFadd{\(438.3\,\text{W}/\text{m}^2\)}\DIFaddend . This distribution is indicative of the
...
steps of one minute. We have identified \DIFdelbegin \DIFdel{34849 }\DIFdelend \DIFaddbegin \DIFadd{33663 }\DIFaddend groups of CE events in the
...
\DIFdelbegin \DIFdel{\(+329.9\pm 112\,\text{kJ}/\text{year}\)}\DIFdelend \DIFaddbegin \DIFadd{\(+430.8\pm 113.2\,\text{kJ}/\text{year}\)}\DIFaddend . The most active months of CE
