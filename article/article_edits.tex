...
%DIF ADD /home/athan/MANUSCRIPTS/02_enhancement/article/article.tex                 Thu Aug 29 13:30:08 2024
...
\(E_{\odot}\) the solar constant adjusted for the actual Sun -- Earth
distance \(r\) and \(r_\text{m}\) is the mean Sun -- Earth distance of
...
}\DIFaddend is negligible (\DIFdelbegin \DIFdel{\(0.1\pm 0.1\,\text{W}/\text{m}^2/\text{year}\)}\DIFdelend \DIFaddbegin \DIFadd{\(+0\pm 0.1\,\text{W}/\text{m}^2/\text{year}\)}\DIFaddend ) and of no
statistical significance. The average \DIFdelbegin \DIFdel{OIR }\DIFdelend \DIFaddbegin \DIFadd{OI }\DIFaddend for the entire period is
