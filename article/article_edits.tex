...
%DIF ADD /home/athan/MANUSCRIPTS/02_enhancement/article/article.tex                 Sat Aug 31 11:28:18 2024
...
mean \DIFdelbegin \DIFdel{OIR }\DIFdelend \DIFaddbegin \DIFadd{OI }\DIFaddend and the yearly excess irradiation for the period 1993 -- 2023,
...
\begin{figure}% [h!]
    ...
    \caption{Time series for the period 1993 -- 2023 of (a) the yearly CE number of occurrences, (b) the yearly mean \DIFdelbeginFL \DIFdelFL{OIR }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{OI }\DIFaddendFL and (c) the yearly excess irradiation. The black lines represent the linear trends on the yearly data.}\label{fig:P-energy}
\end{figure}
...
\caption{Relative frequency distribution of CE events in Thessaloniki for the period 1993 -- 2023 as a function of \DIFdelbeginFL \DIFdelFL{OIR}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{OI. The histogram was split in two plots with different y-axis scales for better readability}\DIFaddendFL .}\label{fig:ovir-distribution}
\end{figure}
...
\caption{Distribution of ECE events in Thessaloniki for the period 1993 -- 2023. \DIFaddbeginFL \DIFaddFL{Measured as extra irradiance over TSI at TOA for the same SZA.}\DIFaddendFL }\label{fig:P-extreme-distribution}
\end{figure}
