...
$`r round(MC[Typ == "Max Glob", wattGLB],1)`\,\text{W}/\text{m}^2$
$`r strftime(MC[Typ == "Max Glob", Date], "%d\\ %B %Y")`\,\text{W}/\text{m}^2$
$`r round(MC[Typ == "Max Glob", GLB_diff],1)`\,\text{W}/\text{m}^2$
$`r round(100*MC[Typ == "Max Glob", GLB_ench],1)`\,\%$

$`r round(MC[Typ == "Max Enha", wattGLB],1)`\,\text{W}/\text{m}^2$
$`r strftime(MC[Typ == "Max Enha", Date], "%d\\ %B %Y")`\,\text{W}/\text{m}^2$
$`r round(MC[Typ == "Max Enha", GLB_diff],1)`\,\text{W}/\text{m}^2$
$`r round(100*MC[Typ == "Max Enha", GLB_ench],1)`\,\%$
...
$`r round(ST_daily[which.max(wattGLB.max), wattGLB.max],1)`\,\text{W}/\text{m}^2$ on
 `r strftime(ST_daily[which.max(wattGLB.max), Date], "%d\\ %B %Y")`, corresponding to OI of 
$`r round(ST_daily[which.max(GLB_diff.max), GLB_diff.max], 1)`\,\text{W}/\text{m}^2$.
!!!!$`r round(100*ST_daily[which.max(GLB_diff.max), GLB_ench.max], 1)`\,\%$.!!!!!
...
!!!$`r round(ST_daily[which.max(GLB_ench.max), wattGLB.max],1)`\,\text{W}/\text{m}^2$!!!!
