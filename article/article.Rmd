...
It has direct practical application, in different energy production method.  The
variability of its intensity, can cause difficulties in predicting the yield and
designing the appropriate equipment. An aspect of this variability are the
interaction 
...
over irradiance (OIR).  To have an estimation and a first insight on the phenomenon,
