...
To give a better understanding of the CE identification procedure, we included 
an example of the CE identification for a selected day .... appendix....
where the use of the reference and the threshold are shown, along with the relevant
measurements.

Similar we provide yearly plots
