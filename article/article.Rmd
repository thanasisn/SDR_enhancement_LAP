...
the $\text{GHI}_\text{ref}$ during the period of study was made using simulation with
the RTM based on the long-term variations of the AOD. As AERONET data start only in
2003, we used for the period 1993 -- 2005 estimates of changes in AOD at
$340\,\text{nm}$ derived from a collocated Brewer spectrophotometer [@Kazadzis2007]
to calculate the trend in $\text{GHI}_\text{ref}$ during this period.
