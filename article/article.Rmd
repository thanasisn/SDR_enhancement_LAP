...
author:
  - Athanasios N. Natsis^[Laboratory of Atmospheric Physics natsisphysicist@gmail.com] 
...
criteria for cloud enhancement identification are set acording the Equation \ref{eq:CE4}
...
Describe set of referce days we used to evalutate
...
knitr::include_graphics("../images/groups-6.png")
```
