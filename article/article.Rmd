...
$`r round(yearlyCE[var == "GLB_diff.N", slope], 0)`\pm
...
```{r ovir-distribution, echo=FALSE, fig.cap="Relative frequency distribution of CE events in Thessaloniki for the period 1993 -- 2023 as a function of OI. The histogram was split in two plots with different y-axis scales for better readability."}
...
```{r P-extreme-distribution, echo=FALSE, fig.cap="Distribution of ECE events in Thessaloniki for the period 1993 -- 2023. Measured as extra irradiance over TSI at TOA for the same SZA."}
