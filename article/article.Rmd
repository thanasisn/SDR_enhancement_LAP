...
For this reason, we decided to use the Libradtran model [@Emde2016], with monthly climatological data from AERONET, as our site is part of this network and operates a Cimel photometer since 2003.
