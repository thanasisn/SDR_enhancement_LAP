...
$0.403$ with a trend of $-3.8±0.93\,\%$ per year, corresponding to a change of
...
Simulations with uvspec for the above Ångström coefficients, with WC of $`r
round(BR[year==1997, pw_avg_mm],1)`\,\text{mm}$ and $`r round(BR[year==2005,
pw_avg_mm],1)`\,\text{mm}$ for 1997 and 2005 respectively and for a SZA of $55^\circ$
