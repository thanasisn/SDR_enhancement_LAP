...
The variable parameters of LUT consists of the month along with the relevant seasonal atmospheric profile,
the climatological values of the alpha, beta parameters of the Ångström
equation for 500nm derived from the 340nm, the WC and the SZA of the simulation.
