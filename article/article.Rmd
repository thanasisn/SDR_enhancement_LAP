...
duration of multiple minutes.  We have identified `r ST_G0[, .N]` groups, where
the group with the longest duration lasted
...
although we detected some CEG with durations longer than an hour, about $80\,\%$ of the CEG have a duration of less than 5 minutes.
