...
For this reason, we decided to use the Libradtran model [@Emde2016], with monthly climatological data for AOD and water column from AERONET [@Giles2019; @Buis1998]. Our site is part of AERONET monitoring network and operates a Cimel photometer since 2003.
We also use the Sun's total solar irradiance from NOAA [@Coddington2005] and Earth - Sun distance calculated by Astropy [@AstropyCollaboration2022].
We have simulated the solar radiation on $0.2^\circ$ SZA's step, for AOD at $500\,\text{nm}$ and offsets of $\pm1$ and $\pm2\sigma$, for water column $\pm1$ and $\pm2\sigma$, and for two atmospheric profiles "AFGL atmospheric constituent profile, midlatitude summer" (afglms) and "AFGL atmospheric constituent profile, midlatitude winter" (afglmw) [@Anderson1986]. 
We used the solar spectra of 

- Kurudz wavelength
- solver

After some evaluation of the modelled conditions, in relation to the GHI data, we choose as more representative of the clear sky radiation, the case with $t_{500} - 1\sigma$ and $wc - 1\sigma$. 
...
For some of this edge cases we further use images from a skycam, in order to evaluate our selection of the thresholds.
