...
experimented with two simple approaches as reference.  The Haurwitz's model
...
atmospheric conditions introduced numerous false positive and false negative
results.  To produce a more accurate reference, we had to take into account more
factors that effect the clear sky radiation and used a radiation transfer model.
...
approach, was also used by @Vamvakas2020.
