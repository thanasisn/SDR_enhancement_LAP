...
With a two branched threshold, as a function of SZA. A constant factor for low SZAs,
and a higher ramped factor for higher SZAs (Equation\nobreakspace\ref{eq:CE4}).
...
These selections has some subjectivity, as the definition of clear sky, is in relation
...
completely removed. The effect of the different clearness levels
