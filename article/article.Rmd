...
while @Dong2022 reported decreases over North America and Europe. To our knowledge,
...
Thessaloniki, Greece.  We used modeled clear sky irradiance, as a baseline to
identify cloud enhancements.  We were able to determine some trends of the
phenomenon, it's Climatology, and some of their  general characteristics. We weren't
able to find a comparable study that provides trends for similar long term dataset,
as ours.  The recording of the GHI signal is the mean of one-minute. Thus, the
minimum resolution of CE events, in this study is one minute.
