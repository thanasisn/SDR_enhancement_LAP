...
(`r round(ST_total$wattGLB.N / 10^6,1)` million one-minute GHI measurements),
...
\begin{figure}[h!]
    ...
    \caption{Time series for the period 1992 -- 2023 of (a) the yearly CE number of occurrences, (b) the yearly mean OIR and (c) the yearly excess irradiation. The black lines represent the linear trends on the yearly data.}\label{fig:cusumnotrendmonthly}
\end{figure}
