...
<!-- (Figure\nobreakspace{}\ref{fig:CEmeanDaily}), -->
using a first-order autoregressive
model with lag of 1 day, with the 'maximum likelihood' fitting method [@Gardner1980;
...
error.  We observe an negligible change of
...
Although, the previous result is closer to the raw data, we preferred to present
the annual statistics, that give a more clear picture about the long term CE
trends. Hence, we calculated the annual values from the one-minute measurements.
Although, the trend of the mean OIR has very weak statistical significance, the
annual number of CE occurrences, shows a steady increase of
...
We have to note that the energy related to the CE events can not be directly
linked with the total energy balance on the atmosphere. The net solar radiation of
the region is not increased, but rather redistributed through the CE events. Resulting,
instantaneous values, that can exceed the equivalent clear sky irradiance to a
considerable level.
