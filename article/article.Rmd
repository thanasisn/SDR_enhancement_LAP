...
The use of the actual modeled values of clear sky GHI, described above , can not provide us with
...
so we created an upper envelope of the clear sky irradiance,
