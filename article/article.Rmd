...
conditions favoring the occurrence of CE events. For the majority (over $60\%$) of
the CE events the OIR is below the long term average of
$`r round(mean(ST_E_yearly$GLB_diff.mean), 1)`\,\text{W}/\text{m}^2$,
while about $10\%$ of the events correspond to OIR larger than
$100\,\text{W}/\text{m}^2$ and up to highest value of 300 W/m^2^.
This distribution is indicative of the magnitude and the probability of the expected
CE
events over Thessaloniki. Similar distribution of CE events, occurrences have been reported
