...
```{r ovir-distribution, echo=FALSE, fig.cap="Relative frequency distribution of CE events in Thessaloniki for the period 1992 -- 2023 as a function of OIR."}
...
```{r ceg-duration-distribution, echo=FALSE, fig.cap="Relative frequency distribution of CE groups of consequent CE events according to their duration for Thessaloniki in the period 1992 -- 2023."}
...
```{r group-2d, echo=FALSE, fig.cap="Relation of excess irradiation of CE groups with their duration for Thessaloniki in the period 1992 -- 2023. The logarithmic color scale denotes the frequency of the respective groups of events."}
...
```{r P-extreme-distribution, echo=FALSE, fig.cap="Distribution of ECE events in Thessaloniki for the period 1992 -- 2023."}
...
events in Thessaloniki for the period 1992 -- 2023.  After analyzing the CE cases, we
