...
$`r round(100*ST_extreme_total$GLB_diff.N_pos/ST_total$wattGLB.N, 3)`\%$ are ECE.
The stronger highest 
...
ST_daily[max(wattGLB.max,na.rm = T), ]

ST_daily[max(GLB_diff.max,na.rm = T), ]
