...
[@Gray2010].  It has direct practical application, in different industries, like
...
timescale and in near real-time (for a review see @Inman2013; @Graabak2016).
...
production [@Lappalainen2020; @Jaervelae2020].


And extreme enhancements cases have the potential to  compromise the integrity of the
infrastructure  [@DoNascimento2019].

Those enhancements have been reported to be able to exceed .... and duration.
...
extreme enhancement irradiances [@Yordanov2015].

It has been reported than enhancements events can interfere in the comparison of
ground data and satellite observe ovations [@Damiani2018]
...
the are summarized by @Gueymard2017.
