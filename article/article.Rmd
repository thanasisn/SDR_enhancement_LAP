...
knitr::include_graphics("../images/P-example-day-3.png")
```
...
knitr::include_graphics("../images/P-energy-complete-multi-3.png")
```
...
```{r group-2d, echo=FALSE, fig.cap="Relation of excess irradiation of CE groups with their duration for Thessaloniki in the period 1994 -- 2023. The logarithmic color scale denotes the frequency of the respective groups. Note that 19 pints with duration higher than 60 min are not shown."}
