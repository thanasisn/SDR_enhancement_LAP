...
compensate for this, we defined the following threshold $\text{E}$ to compare the
measured $\text{GHI}$: 
<!--
...
-->
\begin{equation}
\text{CE} : \text{E} > `r C4_GLB_diff_THRES` + `r C4_cs_ref_ratio` \cdot \text{GHI}_\text{ref} \,\,[\text{W}/\text{m}^2] \label{eq:CE4}
\end{equation}
<!--
...
the TSI at the top of the atmosphere. In this case the threshold EEEEEEEEEE:
