...
irradiance it became evident that changes on the atmospheric conditions introduced
...
radiation. So we used a radiation transfer model in order to include the effects of
